...
- `Zenkai` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `Zenkai` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `Zenkai` inside commands, URLs, package names, or code literals
