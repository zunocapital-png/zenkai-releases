...
const productName = channel === "prod" ? "Zenkai" : `Zenkai ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      Zenkai is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
  ...
  <url type="homepage">https://zenkai.ai</url>
