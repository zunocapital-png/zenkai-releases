export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Zenkai",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Zenkai. ¿Quieres instalarla y reiniciar?",
