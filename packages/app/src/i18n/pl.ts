export const dict = {
  ...
  "dialog.provider.zenkai.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.zenkai.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.zenkaiGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Zenkai.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.zenkaiZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.zenkaiZen.visit.prefix": "Odwiedź ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Zenkai.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w zenkai.json",
  ...
  "dialog.server.description": "Przełącz serwer Zenkai, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Zenkai w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Zenkai w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Zenkai w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.zenkaiReady": "Zenkai jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Zenkai w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Zenkai będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Zenkai nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Zenkai.",
  ...
  "toast.update.description": "Nowa wersja Zenkai ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Zenkai",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (zenkai.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Zenkai nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Zenkai zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Zenkai wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Zenkai",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Zenkai na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Zenkai ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Zenkai.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Zenkai",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Zenkai.",
