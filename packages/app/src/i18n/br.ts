export const dict = {
  ...
  "dialog.provider.zenkai.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.zenkai.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.zenkaiGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Zenkai.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.zenkaiZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.zenkaiZen.visit.prefix": "Visite ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Zenkai.",
  ...
  "dialog.plugins.empty": "Plugins configurados em zenkai.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Zenkai este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Zenkai em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Zenkai em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Zenkai em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "O Zenkai está pronto em {{distro}}.",
  "wsl.onboarding.zenkaiReady": "O Zenkai está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Zenkai em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Zenkai possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Zenkai não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Zenkai novamente.",
  ...
  "toast.update.description": "Uma nova versão do Zenkai ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Zenkai",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (zenkai.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Zenkai ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Zenkai inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Zenkai dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Zenkai",
  ...
  "settings.general.row.appearance.description": "Personalize como o Zenkai aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Zenkai segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Zenkai é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Zenkai iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Zenkai.",
