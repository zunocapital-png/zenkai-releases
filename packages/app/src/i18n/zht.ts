...
export const dict = {
  ...
  "dialog.provider.zenkai.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.zenkai.tagline": "可靠的優化模型",
  "dialog.provider.zenkaiGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Zenkai 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Zenkai 中使用 {{provider}} 模型。",
  ...
  "provider.connect.zenkaiZen.line1": "Zenkai Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.zenkaiZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.zenkaiZen.visit.prefix": "造訪 ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Zenkai 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Zenkai 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 zenkai.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Zenkai 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Zenkai...",
  ...
  "wsl.onboarding.zenkaiReadyIn": "{{distro}} 中的 Zenkai 已就緒。",
  "wsl.onboarding.zenkaiReady": "Zenkai 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Zenkai。",
  "wsl.onboarding.installOpencode": "安裝 Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "未安裝 Zenkai",
  ...
  "wsl.onboarding.wslUnavailable.description": "Zenkai 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Zenkai。",
  ...
  "toast.update.description": "Zenkai 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Zenkai 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (zenkai.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Zenkai 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Zenkai 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Zenkai 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Zenkai 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Zenkai 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Zenkai 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Zenkai 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Zenkai 啟動時自動檢查更新",
