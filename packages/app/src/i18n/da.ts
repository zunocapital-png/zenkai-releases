export const dict = {
  ...
  "dialog.provider.zenkai.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.zenkai.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.zenkaiGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Zenkai.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.zenkaiZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.zenkaiZen.visit.prefix": "Besøg ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Zenkai.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i zenkai.json",
  ...
  "dialog.server.description": "Skift hvilken Zenkai-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Zenkai i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Zenkai i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Zenkai i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Zenkai kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Zenkai kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Zenkai igen.",
  ...
  "toast.update.description": "En ny version af Zenkai ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Zenkai-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (zenkai.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Zenkai understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Zenkai inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Zenkai-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Zenkai",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Zenkai ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Zenkai følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Zenkai er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Zenkai starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Zenkai.",
