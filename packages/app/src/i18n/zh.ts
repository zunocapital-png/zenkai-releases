...
export const dict = {
  ...
  "dialog.provider.zenkai.note": "使用 Zenkai Zen 或 API 密钥连接",
  "dialog.provider.zenkai.tagline": "可靠的优化模型",
  "dialog.provider.zenkaiGo.tagline": "适合所有人的低成本订阅",
  ...
  "dialog.model.unpaid.freeModels.title": "Zenkai 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 Zenkai 中使用 {{provider}} 模型。",
  ...
  "provider.connect.zenkaiZen.line1": "Zenkai Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.zenkaiZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.zenkaiZen.visit.prefix": "访问 ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " 获取你的 API 密钥。",
  "provider.connect.oauth.code.visit.prefix": "访问 ",
  "provider.connect.oauth.code.visit.link": "此链接",
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 Zenkai 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 Zenkai 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 zenkai.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 Zenkai 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Zenkai...",
  "wsl.onboarding.updatingOpencode": "正在更新 Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Zenkai...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Zenkai。",
  "wsl.onboarding.updateOpencode": "更新 Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "{{distro}} 中的 Zenkai 已就绪。",
  "wsl.onboarding.zenkaiReady": "Zenkai 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Zenkai。",
  "wsl.onboarding.installOpencode": "安装 Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "未安装 Zenkai",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Zenkai 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Zenkai 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Zenkai。",
  ...
  "toast.update.description": "Zenkai 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Zenkai 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (zenkai.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: Zenkai 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Zenkai 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Zenkai 服务器。",
  ...
  "settings.general.row.language.description": "更改 Zenkai 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Zenkai 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Zenkai 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Zenkai 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Zenkai 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Zenkai。",
