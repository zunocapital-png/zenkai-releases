export const dict = {
  ...
  "dialog.provider.zenkai.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.zenkai.tagline": "Reliable optimized models",
  "dialog.provider.zenkaiGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Zenkai.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.apiKey.verifying": "Verifying…",
  "provider.connect.apiKey.invalid": "The key didn't work. Check that it's complete and from the right provider.",
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.zenkaiZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.zenkaiZen.visit.prefix": "Visit ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Zenkai.",
  ...
  "dialog.plugins.empty": "Plugins configured in zenkai.json",
  ...
  "dialog.server.description": "Switch which Zenkai server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Zenkai in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Zenkai in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Zenkai in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai is ready in {{distro}}.",
  "wsl.onboarding.zenkaiReady": "Zenkai is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Zenkai in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Zenkai can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Zenkai could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Zenkai.",
  ...
  "toast.update.description": "A new version of Zenkai ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Zenkai team",
  ...
  "error.chain.checkConfig": "Check your config (zenkai.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Zenkai does not support MCP authentication yet.',
  ...
  "session.new.git.none.tooltip": "This project has no Git repository. You can create one from the Review tab to track changes.",
  ...
  "sidebar.gettingStarted.line1": "Zenkai includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Zenkai server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Zenkai",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Zenkai looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Zenkai follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Zenkai is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Zenkai launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Zenkai.",
