...
export const dict = {
  ...
  "dialog.provider.zenkai.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.zenkai.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.zenkaiGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Zenkai zu nutzen.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.zenkaiZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Zenkai zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Zenkai zu nutzen.",
  ...
  "dialog.plugins.empty": "In zenkai.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Zenkai-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Zenkai wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Zenkai in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Zenkai wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Zenkai in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Zenkai in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zenkai aktualisieren",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai ist in {{distro}} bereit.",
  "wsl.onboarding.zenkaiReady": "Zenkai ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Zenkai in {{distro}}.",
  "wsl.onboarding.installOpencode": "Zenkai installieren",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Zenkai einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Zenkai konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Zenkai erneut.",
  ...
  "toast.update.description": "Eine neue Version von Zenkai ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Zenkai-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (zenkai.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Zenkai unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Zenkai enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Zenkai-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Zenkai ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Zenkai auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Zenkai dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Zenkai anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Zenkai automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Zenkai.",
