export const dict = {
  ...
  "dialog.provider.zenkai.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.zenkai.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.zenkaiGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "Zenkaiが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Zenkaiで{{provider}}モデルを使用します。",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.zenkaiZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.zenkaiZen.visit.prefix": " ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してZenkaiで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Zenkaiで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "zenkai.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するZenkaiサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Zenkaiを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のZenkaiを確認中...",
  "wsl.onboarding.updatingOpencode": "Zenkaiを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のZenkaiを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のZenkaiを更新してください。",
  "wsl.onboarding.updateOpencode": "Zenkaiを更新",
  "wsl.onboarding.zenkaiReadyIn": "{{distro}}内のZenkaiの準備ができました。",
  "wsl.onboarding.zenkaiReady": "Zenkaiの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にZenkaiをインストールしてください。",
  "wsl.onboarding.installOpencode": "Zenkaiをインストール",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkaiがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "ZenkaiでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Zenkaiをもう一度開いてください。",
  ...
  "toast.update.description": "Zenkaiの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをZenkaiチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (zenkai.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ZenkaiはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Zenkaiには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でZenkaiサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Zenkaiの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのZenkaiの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Zenkaiがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Zenkaiのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Zenkai の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Zenkai は最新バージョンです。",
