...
export const dict = {
  ...
  "dialog.provider.zenkai.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.zenkai.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.zenkaiGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Zenkai tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Zenkai'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.zenkaiZen.visit.prefix": "",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Zenkai'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Zenkai'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler zenkai.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Zenkai sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Zenkai kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Zenkai kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Zenkai güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Zenkai güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Zenkai'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Zenkai'u güncelle",
  "wsl.onboarding.zenkaiReadyIn": "{{distro}} içinde Zenkai hazır.",
  "wsl.onboarding.zenkaiReady": "Zenkai hazır.",
  "wsl.onboarding.installOpencodeIn": "Zenkai'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Zenkai'u kur",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Zenkai'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Zenkai bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Zenkai'u tekrar açın.",
  ...
  "toast.update.description": "Zenkai'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Zenkai ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (zenkai.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Zenkai henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Zenkai ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Zenkai Masaüstü",
  ...
  "settings.desktop.wsl.description": "Zenkai sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Zenkai'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Zenkai'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Zenkai'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Zenkai'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Zenkai başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Zenkai'un en son sürümünü kullanıyorsunuz.",
