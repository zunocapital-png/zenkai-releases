export const dict = {
  ...
  "dialog.provider.zenkai.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.zenkai.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.zenkaiGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Zenkai",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Zenkai.",
  ...
  "provider.connect.zenkaiZen.line1":
    "يمنحك Zenkai Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.zenkaiZen.visit.prefix": "قم بزيارة ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Zenkai.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في zenkai.json",
  ...
  "dialog.server.description": "تبديل خادم Zenkai الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Zenkai في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Zenkai في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Zenkai في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai جاهز في {{distro}}.",
  "wsl.onboarding.zenkaiReady": "Zenkai جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Zenkai في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Zenkai من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Zenkai التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Zenkai.",
  ...
  "toast.update.description": "نسخة جديدة من Zenkai ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Zenkai",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (zenkai.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Zenkai لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Zenkai نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Zenkai داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Zenkai",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Zenkai على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Zenkai يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Zenkai.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Zenkai",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Zenkai.",
