export const dict = {
  ...
  "dialog.provider.zenkai.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.zenkai.tagline": "Modèles optimisés et fiables",
  "dialog.provider.zenkaiGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Zenkai.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.zenkaiZen.visit.prefix": "Visitez ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Zenkai.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans zenkai.json",
  ...
  "dialog.server.description": "Changez le serveur Zenkai auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Zenkai dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Zenkai dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Zenkai dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai est prêt dans {{distro}}.",
  "wsl.onboarding.zenkaiReady": "Zenkai est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Zenkai dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Zenkai puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Zenkai n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Zenkai.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Zenkai ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Zenkai",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (zenkai.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Zenkai ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Zenkai inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Zenkai dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Zenkai",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Zenkai sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Zenkai suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Zenkai.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Zenkai",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Zenkai.",
