export const dict = {
  ...
  "dialog.provider.zenkai.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.zenkai.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.zenkaiGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Zenkai.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.zenkaiZen.visit.prefix": "Відвідайте ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Zenkai.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в zenkai.json",
  ...
  "dialog.server.description": "Перемкніть сервер Zenkai, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка Zenkai у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення Zenkai у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть Zenkai у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai готовий до роботи у {{distro}}.",
  "wsl.onboarding.zenkaiReady": "Zenkai готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть Zenkai у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Zenkai потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Zenkai не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Zenkai.",
  ...
  "toast.update.description": "Нова версія Zenkai ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Zenkai",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (zenkai.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Zenkai ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Zenkai містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Zenkai всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Zenkai",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Zenkai на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Zenkai використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Zenkai.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Zenkai",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Zenkai.",
