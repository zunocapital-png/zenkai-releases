...
export const dict = {
  ...
  "dialog.provider.zenkai.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.zenkai.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.zenkaiGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Zenkai.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.zenkaiZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.zenkaiZen.visit.prefix": "Besøk ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Zenkai.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i zenkai.json",
  ...
  "dialog.server.description": "Bytt hvilken Zenkai-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Zenkai ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Zenkai-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (zenkai.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Zenkai ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Zenkai inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Zenkai-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Zenkai",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Zenkai ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Zenkai skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Zenkai er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Zenkai starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Zenkai.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Zenkai i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Zenkai i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Zenkai i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai er klar i {{distro}}.",
  "wsl.onboarding.zenkaiReady": "Zenkai er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Zenkai i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Zenkai kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Zenkai kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Zenkai på nytt.",
