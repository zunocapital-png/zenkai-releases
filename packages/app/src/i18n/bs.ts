export const dict = {
  ...
  "dialog.provider.zenkai.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.zenkai.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.zenkaiGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Zenkai-u.",
  ...
  "provider.connect.zenkaiZen.line1":
    "Zenkai Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.zenkaiZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.zenkaiZen.visit.prefix": "Posjeti ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Zenkai-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Zenkai-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u zenkai.json",
  ...
  "dialog.server.description": "Promijeni na koji se Zenkai server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Zenkai u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Zenkai u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Zenkai u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.zenkaiReady": "Zenkai je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Zenkai u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Zenkai mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Zenkai nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Zenkai.",
  ...
  "toast.update.description": "Nova verzija Zenkai-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Zenkai timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (zenkai.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Zenkai još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Zenkai uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Zenkai server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Zenkai-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Zenkai izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Zenkai prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Zenkai-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Zenkai pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Zenkai-a.",
