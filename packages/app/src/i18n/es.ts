export const dict = {
  ...
  "dialog.provider.zenkai.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.zenkai.tagline": "Modelos optimizados y fiables",
  "dialog.provider.zenkaiGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Zenkai",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Zenkai.",
  ...
  "provider.connect.zenkaiZen.visit.prefix": "Visita ",
  "provider.connect.zenkaiZen.visit.link": "zenkai.ai/zen",
  "provider.connect.zenkaiZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Zenkai.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Zenkai.",
  ...
  "dialog.plugins.empty": "Plugins configurados en zenkai.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Zenkai se conecta esta app.",
  ...
  "wsl.onboarding.step.zenkai": "Zenkai",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Zenkai...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Zenkai en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Zenkai...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Zenkai en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Zenkai en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Zenkai",
  "wsl.onboarding.zenkaiReadyIn": "Zenkai está listo en {{distro}}.",
  "wsl.onboarding.zenkaiReady": "Zenkai está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Zenkai en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Zenkai",
  ...
  "wsl.onboarding.distroStatus.zenkaiMissing": "Zenkai no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Zenkai pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Zenkai no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Zenkai.",
  ...
  "toast.update.description": "Una nueva versión de Zenkai ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Zenkai",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (zenkai.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Zenkai no soporta autenticación MCP todavía.',
  ...
  "session.review.noVcs": "Este proyecto no usa Git. Los cambios de cada sesión no se pueden rastrear ni deshacer.",
  ...
  "session.new.git.none": "Sin control de versiones",
  "session.new.git.none.tooltip": "Este proyecto no tiene Git. Puedes crear un repositorio desde la pestaña de Revisión para rastrear cambios.",
  ...
  "sidebar.gettingStarted.line1": "Zenkai incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Zenkai dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Zenkai",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Zenkai en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Zenkai sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Zenkai.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Zenkai",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Zenkai.",
  ...
  "session.review.noVcs.createGit.description": "Permite rastrear, revisar y deshacer los cambios que haga la IA en tus archivos",
