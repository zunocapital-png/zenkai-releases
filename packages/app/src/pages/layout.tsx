...
export default function LegacyLayout(props: ParentProps) {
  ...
  command.register("layout", () => {
    ...
    commands.push(
      {
        id: "git.panel",
        title: "Git: Open Git Panel",
        category: "Tools",
        onSelect: () => openGitPanel(dialog),
      },
      {
        id: "debug.panel",
        title: "Debug: Open Debugger",
        category: "Tools",
        onSelect: () => openDebugPanel(dialog),
      },
      {
        id: "plugins.marketplace",
        title: "Plugins: Open Marketplace",
        category: "Tools",
        onSelect: () => openPluginMarketplace(dialog),
      },
      {
        id: "collab.share",
        title: "Collab: Share Session",
        category: "Tools",
        onSelect: () => openCollabPanel(dialog),
      },
      {
        id: "tools.snippets",
        title: "Tools: Code Snippets",
        category: "Tools",
        onSelect: () => openCodeSnippets(dialog),
      },
      {
        id: "context.smart",
        title: "Context: Smart Context",
        category: "Tools",
        onSelect: () => openSmartContext(dialog),
      },
      {
        id: "performance.monitor",
        title: "Performance: Monitor",
        category: "Tools",
        onSelect: () => openPerformanceMonitor(dialog),
      },
    )
