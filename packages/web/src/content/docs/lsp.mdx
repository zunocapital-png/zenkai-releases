---
title: LSP Servers
description: Zenkai integrates with your LSP servers.
---

Zenkai can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Zenkai comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and zenkai opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your zenkai config.
