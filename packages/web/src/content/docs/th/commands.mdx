...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Zenkai:
...
- ระดับผู้ใช้ (Global): `~/.config/zenkai/commands/`
- ระดับโปรเจ็กต์: `.zenkai/commands/`
...
Zenkai มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
