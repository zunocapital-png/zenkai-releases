---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące zenkai.
---

Funkcja udostępniania zenkai umożliwia tworzenie publicznych linków do konwersacji zenkai, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, zenkai:
...
zenkai obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie zenkai korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `zenkai.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu zenkai w Twojej organizacji.
