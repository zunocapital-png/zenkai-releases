---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala zenkai.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

zenkai zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie zenkai uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI zenkai, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do zenkai. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij zenkai. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `zenkai.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Zenkai czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `zenkai.default`.
