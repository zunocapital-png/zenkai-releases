...
Utwórz `.zenkai/commands/test.md`:
...
Możesz zdefiniować polecenia w `zenkai.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji zenkai:
...
- Globalnie: `~/.config/zenkai/commands/`
- Na projekt: `.zenkai/commands/`
...
zenkai zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
