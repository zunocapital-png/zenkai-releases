---
title: Serwery LSP
description: Zenkai integruje się z serwerami LSP.
---

Zenkai może integrować się z serwerami Language Server Protocol (LSP), aby używać diagnostyki jako informacji zwrotnej dla agenta.

---

## Wbudowane

Zenkai posiada kilka wbudowanych serwerów LSP dla następujących języków:
...
Gdy LSP jest włączony i Zenkai otwiera plik:
...
Możesz włączać i dostosowywać serwery LSP poprzez sekcję `lsp` w konfiguracji Zenkai.
