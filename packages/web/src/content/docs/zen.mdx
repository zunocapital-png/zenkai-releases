---
title: Zen
description: Curated list of models provided by Zenkai.
---
...
Zenkai Zen is a list of tested and verified models provided by the Zenkai team.

Zen works like any other provider in Zenkai. You login to Zenkai Zen and get
...
:::tip
We tested a select group of models and providers that work well with Zenkai.
:::
...
Zenkai Zen is an AI gateway that gives you access to these models.

---

## How it works

Zenkai Zen works like any other provider in Zenkai.

1. You sign in to **<a href={console}>Zenkai Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Zenkai Zen, and paste your API key.
...
The [model id](/docs/config/#models) in your Zenkai config
uses the format `zenkai/<model-id>`. For example, for GPT 5.5, you would
use `zenkai/gpt-5.5` in your config.
...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. Zenkai uses these models to generate session titles.
...
- DeepSeek V4 Flash Free is available on Zenkai for a limited time. The team is using this time to collect feedback and improve the model.
- MiMo-V2.5 Free is available on Zenkai for a limited time. The team is using this time to collect feedback and improve the model.
- Laguna S 2.1 Free is available on Zenkai for a limited time. The team is using this time to collect feedback and improve the model.
- Ling-3.0-flash Free is available on Zenkai for a limited time. The team is using this time to collect feedback and improve the model.
- North Mini Code Free is available on Zenkai for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on Zenkai for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Zenkai for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Zenkai as well.
