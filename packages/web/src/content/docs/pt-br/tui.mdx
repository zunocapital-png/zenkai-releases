---
title: TUI
description: Usando a interface de usuário de terminal zenkai.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O zenkai fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar zenkai inicia o TUI para o diretório atual.
...
Ao usar o TUI do zenkai, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao zenkai. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do zenkai. _Aliases_: `/quit`, `/q`
...
Isso é separado do `zenkai.json`, que configura o comportamento do servidor/runtime.
...
- `leader_timeout` - Controla por quanto tempo o Zenkai espera depois da leader key. O padrão é `2000`.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `zenkai.default`.
