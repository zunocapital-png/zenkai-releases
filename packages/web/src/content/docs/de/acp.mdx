...
description: Verwenden Sie Zenkai in jedem ACP-kompatiblen Editor.
---

Zenkai unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um Zenkai über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `zenkai acp`.

Der Befehl startet Zenkai als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „Zenkai“ in der AI Chat Agent Selector.
...
Um Zenkai als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass Zenkai als ACP-Agent für den Chat verwendet wird.
...
Zenkai funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer Zenkai-Konfiguration konfiguriert sind
