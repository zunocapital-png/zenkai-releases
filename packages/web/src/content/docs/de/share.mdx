---
title: Teilen
description: Teile Zenkai-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Zenkai-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Zenkai Folgendes:
...
Zenkai hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Zenkai den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`zenkai.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du zenkai in deiner Organisation einsetzt.
