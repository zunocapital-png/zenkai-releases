---
title: LSP Server
description: Zenkai lässt sich in Ihren LSP-Server integrieren.
---

Zenkai kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

Zenkai verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und Zenkai eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Zenkai-Konfiguration aktivieren und anpassen.
