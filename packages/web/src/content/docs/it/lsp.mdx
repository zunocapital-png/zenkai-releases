---
title: Server LSP
description: Zenkai si integra con i tuoi server LSP.
---

Zenkai può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Zenkai include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e zenkai apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di zenkai.
