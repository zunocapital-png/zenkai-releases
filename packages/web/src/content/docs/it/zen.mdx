---
title: Zen
description: Lista curata di modelli fornita da Zenkai.
---
...
Zenkai Zen è un elenco di modelli testati e verificati forniti dal team di Zenkai.

Zen funziona come qualsiasi altro provider in Zenkai. Accedi a Zenkai Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con Zenkai.
:::
...
Zenkai Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

Zenkai Zen funziona come qualsiasi altro provider in Zenkai.

1. Accedi a **<a href={console}>Zenkai Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona Zenkai Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di Zenkai
usa il formato `zenkai/<model-id>`. Per esempio, per GPT 5.5, useresti
`zenkai/gpt-5.5` nella tua config.
...
Potresti notare [modelli a basso costo](/docs/config/#models), come Haiku, Nano o Flash, nella cronologia di utilizzo. Zenkai usa questi modelli per generare i titoli delle sessioni.
...
- DeepSeek V4 Flash Free è disponibile su Zenkai per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su Zenkai per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Laguna S 2.1 Free è disponibile su Zenkai per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Ling-3.0-flash Free è disponibile su Zenkai per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su Zenkai per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su Zenkai per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su Zenkai per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con Zenkai.
