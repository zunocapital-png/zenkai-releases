...
Puoi aggiungere comandi personalizzati tramite la config di Zenkai o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Zenkai:
...
- Globale: `~/.config/zenkai/commands/`
- Per progetto: `.zenkai/commands/`
...
zenkai include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
