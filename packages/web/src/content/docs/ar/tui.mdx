---
title: TUI
description: استخدام واجهة المستخدم TUI في Zenkai.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Zenkai واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Zenkai إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Zenkai في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Zenkai. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Zenkai. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `zenkai.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار Zenkai بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `zenkai.default`.
