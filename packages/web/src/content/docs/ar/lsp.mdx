---
title: خوادم LSP
description: يتكامل Zenkai مع خوادم LSP لديك.
---

يمكن أن يتكامل Zenkai مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Zenkai مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح zenkai لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات zenkai.
