---
title: Zen
description: قائمة منتقاة من النماذج يوفّرها Zenkai.
---
...
Zenkai Zen هي قائمة بالنماذج التي اختبرها فريق Zenkai وتحقّق منها.

يعمل Zen مثل أي مزوّد آخر في Zenkai. تسجّل الدخول إلى Zenkai Zen وتحصل على
مفتاح API. استخدامه **اختياري بالكامل** ولا تحتاج إليه لاستخدام Zenkai.
...
:::tip
اختبرنا مجموعة منتقاة من النماذج والمزوّدين الذين يعملون جيدا مع Zenkai.
:::
...
Zenkai Zen هي بوابة AI تتيح لك الوصول إلى هذه النماذج.

---

## كيف يعمل

يعمل Zenkai Zen مثل أي مزوّد آخر في Zenkai.

1. تسجّل الدخول إلى **<a href={console}>Zenkai Zen</a>**، وتضيف تفاصيل الفوترة، ثم تنسخ مفتاح API.
2. تشغّل الأمر `/connect` في واجهة TUI، وتختار Zenkai Zen، ثم تلصق مفتاح API.
...
يستخدم [معرّف النموذج](/docs/config/#models) في إعدادات Zenkai الصيغة `zenkai/<model-id>`. على سبيل المثال، بالنسبة إلى GPT 5.5، ستستخدم `zenkai/gpt-5.5` في إعداداتك.
...
قد تلاحظ [نماذج منخفضة التكلفة](/docs/config/#models)، مثل Haiku أو Nano أو Flash، في سجل الاستخدام. يستخدم Zenkai هذه النماذج لإنشاء عناوين الجلسات.
...
- DeepSeek V4 Flash Free متاح على Zenkai لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- MiMo-V2.5 Free متاح على Zenkai لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Laguna S 2.1 Free متاح على Zenkai لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Ling-3.0-flash Free متاح على Zenkai لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- North Mini Code Free متاح على Zenkai لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Nemotron 3 Ultra Free متاح على Zenkai لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
- Big Pickle نموذج خفي ومتاح مجانا على Zenkai لفترة محدودة. يستخدم الفريق هذه الفترة لجمع الملاحظات وتحسين النموذج.
...
4. **عدم فرض أي ارتباط حصري** عبر تمكينك من استخدامه مع أي عامل برمجة آخر. ومع إبقاء إمكانية استخدام أي مزوّد آخر مع Zenkai أيضا دائما.
