---
title: دعم ACP
description: استخدم Zenkai في أي محرر متوافق مع ACP.
---

يدعم Zenkai بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام Zenkai عبر ACP، اضبط محررك ليشغّل الأمر `zenkai acp`.

يشغّل هذا الأمر Zenkai كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'Zenkai' من محدد الوكلاء في AI Chat.
...
لاستخدام Zenkai كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام Zenkai كوكيل ACP للدردشة.
...
يعمل Zenkai عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات Zenkai
