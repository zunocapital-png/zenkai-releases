...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في zenkai.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في zenkai مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.zenkai/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/zenkai/tools/`.
