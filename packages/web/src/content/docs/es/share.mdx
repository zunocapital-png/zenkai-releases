---
title: Compartir
description: Comparte tus conversaciones Zenkai.
---

La función para compartir de Zenkai te permite crear enlaces públicos a tus conversaciones de Zenkai, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, Zenkai:
...
Zenkai admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, Zenkai usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `zenkai.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de zenkai en su organización.
