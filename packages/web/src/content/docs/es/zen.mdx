---
title: Zen
description: Lista seleccionada de modelos proporcionada por Zenkai.
---
...
Zenkai Zen es una lista de modelos probados y verificados proporcionada por el equipo de Zenkai.

Zen funciona como cualquier otro proveedor en Zenkai. Inicias sesión en Zenkai Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Zenkai.
:::
...
Zenkai Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Zenkai Zen funciona como cualquier otro proveedor en Zenkai.

1. Inicias sesión en **<a href={console}>Zenkai Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Zenkai Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Zenkai
usa el formato `zenkai/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`zenkai/gpt-5.5` en tu configuración.
...
Puede que notes [modelos de bajo costo](/docs/config/#models), como Haiku, Nano o Flash, en tu historial de uso. Zenkai usa estos modelos para generar títulos de sesiones.
...
- DeepSeek V4 Flash Free está disponible en Zenkai por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en Zenkai por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Laguna S 2.1 Free está disponible en Zenkai por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Ling-3.0-flash Free está disponible en Zenkai por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- North Mini Code Free está disponible en Zenkai por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en Zenkai por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Zenkai por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Zenkai.
