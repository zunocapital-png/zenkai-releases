...
Puede agregar comandos personalizados a través de la configuración Zenkai o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Zenkai [config](/docs/config):
...
zenkai incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
