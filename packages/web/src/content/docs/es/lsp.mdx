...
description: Zenkai se integra con sus servidores LSP.
---

Zenkai puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

Zenkai viene con varios servidores LSP integrados para idiomas populares:
...
Cuando LSP está habilitado y zenkai abre un archivo:
...
Puede habilitar y personalizar los servidores LSP a través de la sección `lsp` en su configuración zenkai.
