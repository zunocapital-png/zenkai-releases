---
title: LSP-servere
description: zenkai integreres med LSP-serverne dine.
---

Zenkai kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Zenkai kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og zenkai åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Zenkai-konfigurasjonen.
