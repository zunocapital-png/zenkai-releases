---
title: Zen
description: Utvalgt liste over modeller levert av Zenkai.
---
...
Zenkai Zen er en liste over testede og verifiserte modeller levert av Zenkai-teamet.

Zen fungerer som enhver annen leverandør i Zenkai. Du logger inn på Zenkai Zen og får
...
Zenkai Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Zenkai Zen fungerer som enhver annen leverandør i Zenkai.

1. Du logger inn på **<a href={console}>Zenkai Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Zenkai Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Zenkai-konfigurasjonen din
bruker formatet `zenkai/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `zenkai/gpt-5.5` i konfigurasjonen din.
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. Zenkai bruker disse modellene til å generere økttitler.
...
- DeepSeek V4 Flash Free er tilgjengelig på Zenkai i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på Zenkai i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Laguna S 2.1 Free er tilgjengelig på Zenkai i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling-3.0-flash Free er tilgjengelig på Zenkai i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på Zenkai i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Zenkai i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Zenkai i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Zenkai også.
