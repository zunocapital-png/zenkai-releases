---
title: TUI
description: Bruke zenkai-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Zenkai gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Zenkai starter TUI for gjeldende katalog.
...
Når du bruker Zenkai TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Zenkai. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Zenkai. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `zenkai.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Zenkai venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `zenkai.default`.
