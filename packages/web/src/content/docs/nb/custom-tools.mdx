...
description: Lag verktøy som LLM kan kalle inn Zenkai.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Zenkai sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.zenkai/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/zenkai/tools/`.
