...
Agentferdigheter lar Zenkai oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går zenkai opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
zenkai viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `zenkai.json`:
