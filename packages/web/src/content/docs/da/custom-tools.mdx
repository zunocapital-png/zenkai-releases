...
description: Opret værktøjer, som LLM kan kalde zenkai ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med zenkais [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.zenkai/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/zenkai/tools/`.
