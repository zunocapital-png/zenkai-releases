...
Du kan tilføje brugerdefinerede kommandoer gennem Zenkai-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din Zenkai [config](/docs/config):
...
- Globalt: `~/.config/zenkai/commands/`
- Pr. projekt: `.zenkai/commands/`
...
zenkai indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
