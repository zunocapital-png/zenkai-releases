---
title: Zen
description: Udvalgt liste over modeller leveret af Zenkai.
---
...
Zenkai Zen er en liste over testede og verificerede modeller leveret af Zenkai-teamet.

Zen fungerer som enhver anden udbyder i Zenkai. Du logger ind på Zenkai Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med Zenkai.
:::
...
Zenkai Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

Zenkai Zen fungerer som enhver anden udbyder i Zenkai.

1. Du logger ind på **<a href={console}>Zenkai Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger Zenkai Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din Zenkai-konfiguration
bruger formatet `zenkai/<model-id>`. For eksempel ville du for GPT 5.5
bruge `zenkai/gpt-5.5` i din konfiguration.
...
Du vil måske bemærke [lavprismodeller](/docs/config/#models), såsom Haiku, Nano eller Flash, i din brugshistorik. Zenkai bruger disse modeller til at generere sessionstitler.
...
- DeepSeek V4 Flash Free er tilgængelig på Zenkai i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- MiMo-V2.5 Free er tilgængelig på Zenkai i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Laguna S 2.1 Free er tilgængelig på Zenkai i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling-3.0-flash Free er tilgængelig på Zenkai i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- North Mini Code Free er tilgængelig på Zenkai i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Ultra Free er tilgængelig på Zenkai i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Big Pickle er en stealth-model, som er gratis på Zenkai i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med Zenkai også.
