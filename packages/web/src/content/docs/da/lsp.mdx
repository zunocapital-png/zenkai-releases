---
title: LSP-servere
description: Zenkai integreres med dine LSP-servere.
---

Zenkai kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Zenkai leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og zenkai åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din zenkai-konfiguration.
