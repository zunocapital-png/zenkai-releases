...
`.zenkai/commands/test.md` oluştur:
...
zenkai işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

zenkai [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/zenkai/commands/`
- Proje başına: `.zenkai/commands/`
...
zenkai, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
