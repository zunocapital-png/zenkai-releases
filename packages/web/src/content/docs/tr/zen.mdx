---
title: Zen
description: zenkai tarafından sağlanan seçilmiş modeller listesi.
---
...
Zenkai Zen, Zenkai ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Zenkai'daki diğer sağlayıcılar gibi çalışır. Zenkai Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Zenkai kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Zenkai ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Zenkai Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Zenkai Zen, Zenkai'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Zenkai Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Zenkai Zen'i seçin ve API anahtarınızı yapıştırın.
...
Zenkai yapılandırmanızdaki [model id](/docs/config/#models) `zenkai/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `zenkai/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. Zenkai, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için Zenkai'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için Zenkai'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Laguna S 2.1 Free, sınırlı bir süre için Zenkai'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ling-3.0-flash Free, sınırlı bir süre için Zenkai'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için Zenkai'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Zenkai'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Zenkai'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Zenkai Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Zenkai ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
