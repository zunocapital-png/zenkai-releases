---
title: Paylasim
description: zenkai konusmalarini genel baglantilarla paylasin.
---

zenkai'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda zenkai:
...
zenkai, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak zenkai manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `zenkai.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda zenkai kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
