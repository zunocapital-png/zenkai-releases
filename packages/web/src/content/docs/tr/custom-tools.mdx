---
title: Özel Araçlar
description: LLM'un zenkai'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. zenkai'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.zenkai/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/zenkai/tools/` içine yerleştirerek.
