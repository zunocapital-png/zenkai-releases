...
description: Zenkai, LSP sunucularınızla bütünleşir.
---

Zenkai, tanılamayı agent için geri bildirim olarak kullanmak üzere Language Server Protocol (LSP) sunucularıyla bütünleşebilir.

---

## Yerleşik

Zenkai, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP etkinleştirildiğinde ve zenkai bir dosyayı açtığında:
...
LSP sunucularını, zenkai yapılandırmanızdaki `lsp` bölümü aracılığıyla etkinleştirebilir ve özelleştirebilirsiniz.
