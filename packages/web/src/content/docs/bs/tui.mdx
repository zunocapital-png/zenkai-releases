---
title: TUI
description: Korištenje korisničkog interfejsa Zenkai terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Zenkai pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Zenkai pokreće TUI za trenutni direktorij.
...
Kada koristite Zenkai TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Zenkai. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Zenkai. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `zenkai.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Zenkai čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `zenkai.default`.
