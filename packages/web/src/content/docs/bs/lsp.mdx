---
title: LSP serveri
description: Zenkai se integriše sa vašim LSP serverima.
---

Zenkai se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Zenkai dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
Kada je LSP omogućen i zenkai otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj zenkai konfiguraciji.
