---
title: ACP podrška
description: Koristite Zenkai u bilo kojem uređivaču kompatibilnom sa ACP.
---

Zenkai podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili Zenkai putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `zenkai acp`.

Naredba pokreće Zenkai kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "Zenkai" agenta u AI Chat agent selektoru.
...
Da koristite Zenkai kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi Zenkai kao ACP chat agenta.
...
Zenkai radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj Zenkai konfiguraciji
