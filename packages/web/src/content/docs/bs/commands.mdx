...
Kreiraj `.zenkai/commands/test.md`:
...
Možete dodati prilagođene komande kroz Zenkai konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Zenkai [config](/docs/config):
...
- Globalno: `~/.config/zenkai/commands/`
- Po projektu: `.zenkai/commands/`
...
Zenkai uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
