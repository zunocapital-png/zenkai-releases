...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a shareable link",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.zenkai/commands/{/highlight} for reusable prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.zenkai/agents/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.zenkai/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.zenkai/plugins/{/highlight} for event hooks",
  ...
  "Create JSON theme files in {highlight}.zenkai/themes/{/highlight} directory",
