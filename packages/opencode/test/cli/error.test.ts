  ...
  test("formats legacy and tagged config errors the same way", () => {
    const cases = [
      ...
      },
      {
        ...
        data: { path: "/tmp/opencode.jsonc", dir: ".zenkai", suggestion: "opencode" },
        expected:
          'Directory ".zenkai" in /tmp/opencode.jsonc is not valid. Rename the directory to "opencode" or remove it. This is a common typo.',
      },
      {
