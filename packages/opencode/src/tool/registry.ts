...
import { CodingTools } from "./coding_tools"
import { GenerateImageTool } from "./generate_image"
import { StudyFolderTool } from "./study_folder"
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const codingtools = yield* CodingTools
    const generateimage = yield* GenerateImageTool
    const studyfolder = yield* StudyFolderTool
    ...
    const state = yield* InstanceState.make<State>(
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        const tool = yield* Effect.all({
          ...
          git_tools: Tool.init(gittools),
          coding_tools: Tool.init(codingtools),
          generate_image: Tool.init(generateimage),
          study_folder: Tool.init(studyfolder),
