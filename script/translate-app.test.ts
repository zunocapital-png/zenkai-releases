...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".zenkai/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".zenkai/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".zenkai/glossary/zh-tw.md")
  })
